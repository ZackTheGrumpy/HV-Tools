...
title HV Bypass Tool v4.0.1 - Modernized Edition
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Start-Process -FilePath '%comspec%' -ArgumentList ('/c ""' + $env:SCRIPT_PATH + '"" %*') -Verb RunAs" >nul 2>&1
if !errorLevel! neq 0 (
    echo.
